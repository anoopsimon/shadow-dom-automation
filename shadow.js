...
/*
    get an element based on the text
*/
function getElementByText(selector, text) {
  var elements = querySelectorAllDeep(selector).find(function (element) {
    // Only include element having text  EQUALS IGNORE CASE <text>
...
function scrollTo(selector) {
	querySelectorDeep(selector).scrollIntoView({block: "center", inline: "nearest"});
};

/**
 * Scroll to an element , with scroll behaviour as parameter
 * @param {*} selector 
 * @param {*} scrollBehaviour 
 */
function scrollTo(selector, scrollBehaviour) {
	querySelectorDeep(selector).scrollIntoView(scrollBehaviour);
};
...
//usage
//usage for all elements
querySelectorAllDeep("input[id*='loanOptions-repaymentFrequency']");
